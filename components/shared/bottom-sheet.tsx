...
>(({ index = 0, backgroundStyle, style, handleIndicatorStyle, ...props }, ref) => {
  ...
  return (
    <BottomSheetModal
      ref={ref}
      index={index}
      backgroundStyle={[tw.style('bg-white'), backgroundStyle]}
      style={[tw.style('rounded-tl-3xl rounded-tr-3xl'), style]}
      handleIndicatorStyle={[tw.style('bg-neutral-300'), handleIndicatorStyle]}
